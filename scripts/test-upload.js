...
async function testUpload() {
  ...
  try {
    ...
    const { data: buckets, error: bucketsError } = await prodSupabase.storage.listBuckets();
    ...
    const { data: imageUploadData, error: imageUploadError } = await prodSupabase.storage
      .from('venue-photos')
    ...
    console.log('   The issue might be with the file download or MIME type detection.');
